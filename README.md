...
The company  is a globally renowned brand and a prominent retailer in the United States.its a preferred shopping destination by offering outstanding value, inspiration, innovation and an exceptional guest experience that no other retailer can deliver.
...
Assuming you are a data analyst/ scientist at the company, you have been assigned the task of analyzing the given dataset to extract valuable insights and provide actionable recommendations.
